...
import com.dmware.api_onibusbh.config.ModelMapperConfig;
...
public class LinhasService {
      ...
      Logger logger = Logger.getLogger(LinhasService.class.getName());
      ...
      public List<LinhaDTO> fetchLinhas() {
            ...
            try {
                  ...
                  logger.info("Linhas existentes: " + linhasExistentes.size());
